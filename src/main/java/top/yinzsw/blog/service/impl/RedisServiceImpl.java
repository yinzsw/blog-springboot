...
public class RedisServiceImpl implements RedisService {
    ...
    public Map<Object, Double> zRangeWithScores(String key, long start, long end) {
        return Objects.requireNonNull(redisTemplate.opsForZSet().rangeWithScores(key, start, end)).stream()
    ...
    public Map<Object, Double> zReverseRangeWithScores(String key, long start, long end) {
        return Objects.requireNonNull(redisTemplate.opsForZSet().reverseRangeWithScores(key, start, end)).stream()
                .collect(Collectors.toMap(ZSetOperations.TypedTuple::getValue, ZSetOperations.TypedTuple::getScore));
    }
